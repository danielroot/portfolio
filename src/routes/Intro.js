    ...
    >
      <div className="intro">
        ...
        <p>Currently working as <strong>Sr. UX Product Designer at Walmart Omni Services</strong> and focused on the Auto Care Business.</p> */}
          ...
          <p>
            Since 2008, I&apos;ve evolved from UX Engineer to Senior UX/UI Product Designer,
            working at creative agencies (<strong>Deloitte Digital</strong>) and
            in-house teams (<strong>Uber</strong> and <strong>Walmart</strong>).
          </p>
          <p>
            I excel at creating intuitive experiences through collaborative problem-solving and consensus building. My
