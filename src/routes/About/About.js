  ...
  return (
    <React.Fragment>
      ...
      <section>
        ...
        <h3>Design</h3>
        <p>
        I graduated in 2006 with a degree in Visual Arts (focused in Graphic Design) from SUNY New Paltz. There, I learned the history, theory, and application of Graphic Design. My tools of choice for UI design are Sketch/Figma and the browser.
        </p>

        <h3>Coding</h3>
        <p>
          My modern Front End Development workflow includes VS Code, Git, React JS,
          Sass/Less, NPM, and Webpack.
          </p>
      </section>
      ...
      <section className="clients">
        ...
        <ul>
          ...
          <li>Hitachi</li>
          <li>Lineage</li>
          <li><Link to="/project/lululemon">Lululemon</Link></li>
          <li>Nike
          </li>
          <li>
          ...
          <li>USGA</li>
          <li>VMWare</li>
          <li><Link to="/project/walmart">Walmart Labs</Link></li>
          <li>Watson IBM</li>
        </ul>
      </section>
    </React.Fragment>
